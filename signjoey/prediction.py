...
def validate_on_data(
    ...
    with torch.no_grad():
        ...
        all_other_outputs = defaultdict(list)
        # if output_attention:
        ...
        for batch in tqdm(iter(valid_iter), disable=tqdm_disable):
            ...
            with torch.cuda.amp.autocast(enabled=use_amp):
                ...
                for op_key, op_value in other_outputs.items():
                    all_other_outputs[op_key] += [op_value[si].detach().cpu().numpy() 
    ...
    results['other_outputs'] = all_other_outputs
    if do_recognition:
    ...
    if do_recognition:
        ...
        if save_immediate_results:
            save_immediate_results_fun(
                ...
                **dev_recognition_results.get('other_outputs',{}))
            ...
            for ta in translation_beam_alphas:
                ...
                if save_immediate_results:
                    save_immediate_results_fun(
                        ...
                        **dev_translation_results[tbw][ta].get('other_outputs',{}))
